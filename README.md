...
Import the provided SQL schema (found in /src/API/database/LMS.sql).
2. Backend Setup
Ensure your project folder is located in C:/xampp/htdocs/LMS.
Verify connection settings in src/API/dbconfig.php:
php
$host = "localhost";
$user = "root";
$pass = "";
